...
void emAfMessageSentHandler(EmberOutgoingMessageType type,
                            ...
                            uint8_t messageTag)
{
//	bool fragStatus =emAfFragmentationMessageSent(apsFrame,status);
//	if(fragStatus== true)
//	{
//		emberAfCorePrintln("emAfFragmentationMessageSent--- frag handeller message");
//		return;
//	}
  EmberAfMessageSentFunction callback;
  if (status != EMBER_SUCCESS) {
